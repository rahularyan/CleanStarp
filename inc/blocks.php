...
class qa_html_theme extends qa_html_theme_base
{
    ...
    function head_script()
    {
		...
		if(true) //check for notification option
			$this->output('<script type="text/javascript" src="' . Q_THEME_URL . '/js/notifications.js"></script>');
    }
			...
			if (isset( $userid )){
				...
				$this->output('
					...
					<ul class="nav navbar-nav not-nav message-bar pull-right">
						<li class="button dropdown">
							<a href="' . qa_path_html('message/' . $handle ) . '" class="icon-chat dropdown-toggle messagelist" data-toggle="dropdown" id="messagelist">messages</a>
