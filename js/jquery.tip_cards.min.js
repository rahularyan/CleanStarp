    ...
    el.find(settings.triggerSelector).addClass("tc_click_target").click(function() {
      ...
      $(".tc_next").click(function() {
        if ($(".tc_card.active").next(".tc_card").length > 0 && !$(this).hasClass("animated")) {
          ...
          var content = "<div class='tc_inner_modal tc_flipped'>" + $($(".tc_card.active").removeClass("active").next(".tc_card").addClass("active").find(".tc_click_target").attr("href")).html() + "</div>";
      ...
      $(".tc_prev").click(function() {
        if ($(".tc_card.active").prev(".tc_card").length > 0 && !$(this).hasClass("animated")) {
          var el3 = $(this);
          el3.addClass("animated");
          var content = "<div class='tc_inner_modal tc_flipped'>" + $($(".tc_card.active").removeClass("active").prev(".tc_card").addClass("active").find(".tc_click_target").attr("href")).html() + "</div>";
          $(".tc_main_modal").addClass("old").clone().removeClass("old").addClass("tc_to_bottom force new").html(content).insertAfter(".tc_main_modal.old")
      ...
      function addExtraButtons(settings) {
		$(".tc_main_modal").prepend("<div class='control-btn'></div>");
        if (settings.closeButton != false ) {
          $(".tc_main_modal .control-btn").prepend("<a class='tc_close icon-cancel2' href='#' title='"+settings.closeButton+"'></a>");
          $(".tc_main_modal .tc_flip_toggle").remove();
        }
        if (settings.flipButton != false && $(".tc_main_modal").find(".tc_front").length > 0 ) {
          $(".tc_main_modal .tc_flip_toggle").remove();
          $(".tc_main_modal .control-btn").prepend("<a class='tc_flip_toggle icon-refresh' href='#' title='"+settings.flipButton+"'></a>");
        }
        ...
        $(".tc_overlay, .tc_close").click(function() {
          ...
          $(".tc_modal").attr("style","").one('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend', function(e) {
            ...
            $("body").removeClass("tc_modal_open")
			 if (typeof settings.afterModalClose == 'function') settings.afterModalClose();
          });
          return false;
        });
